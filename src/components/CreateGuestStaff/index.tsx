...
export function CreateGuestStaff() {
  ...
  return (
    <div className="guest-card">
      ...
      <style>{`
        .guest-card { border: 1px solid var(--color-border, #333); border-radius: 0.5rem; padding: 1rem; margin-bottom: 1.5rem; background: var(--color-bg-secondary, #1a1f25); }
