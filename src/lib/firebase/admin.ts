...
/**
 * Reserved inventory location ID for the RnR Online Store (non-physical).
 * Online Store items can be flagged availableOnline: true to promote to the storefront.
